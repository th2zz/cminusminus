...
public class P6 {
    ...
    public static void main(String[] args){
			Type t = new StructDefType();
			//System.out.println("STRUCTDEFTYPE TO STRING: "+t.toString());
			Type i = new IntType();
			//System.out.println("INTTYPE TO STRING: "+i.toString());
			Type v = new VoidType();
			//System.out.println("VOIDTYPE TO STRING: "+v.toString());
